...
def train_vis_all(config, meta=None, cameras=None, resize_transform=None, inputs=None, input_heatmaps=None, \
        fused_poses=None, plane_poses=None, proposal_centers=None, grid_centers=None, prefix=None):
    ...
    if '3d_cubes' in config.TRAIN.VIS_TYPE:
        save_debug_3d_cubes(config, meta, grid_centers, prefix)

    if 'image_with_3d_poses' in config.TRAIN.VIS_TYPE:
        save_debug_3d_images(config, meta, fused_poses, prefix)

def test_vis_all(config, meta=None, cameras=None, resize_transform=None, inputs=None, input_heatmaps=None, \
        fused_poses=None, plane_poses=None, proposal_centers=None, grid_centers=None, prefix=None):
...
def save_debug_3d_cubes(config, meta, root, prefix):
    ...
    root_id = config.DATASET.ROOT_JOINT_ID
