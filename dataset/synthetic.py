...
class Synthetic(JointsDataset):
    def __init__(self, cfg, is_train=True, transform=None):
        ...
        self.db_file = '{}_{}_cam{}.pkl'.format(self.model_name, self.image_set, self.num_views)
    ...
    def _get_db(self):
        ...
        logger.info(" ===> Build {} synthetic DB file ...".format(self.image_set))

        for _ in tqdm(range(self.num_of_data)):
            bbox_list = []
            center_list = []
